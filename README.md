...
| **[🔄 Immutability](./benchmarks/immutability/)** | Immutability helper libraries | 5 | ![Active](https://img.shields.io/badge/Active-success) | **[View →](./benchmarks/immutability/)** |
| **[🧭 Router](./benchmarks/router/)** | React routing libraries | 3 | ![WIP](https://img.shields.io/badge/WIP-yellow) | **[View →](./benchmarks/router/)** |
