...
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 38,515,286.151 | ±0.24% | 0.0260ms | 0.0830ms |  |
| 🥈 | **Zen** | 22,373,839.687 | ±0.71% | 0.0447ms | 0.0840ms |  |
| 🥉 | **Preact Signals** | 22,057,344.5 | ±0.18% | 0.0453ms | 0.0840ms |  |
| 4 | **MobX** | 4,049,759.085 | ±0.22% | 0.2469ms | 0.4170ms |  |
| 5 | **Jotai** | 639,976.367 | ±3.96% | 1.5626ms | 2.9160ms |  |
...
| Rank | Library | Ops/sec | Variance | Mean | p99 | Samples |
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 37,902,421.773 | ±0.04% | 0.0264ms | 0.0830ms |  |
| 🥈 | **Zen** | 33,622,057.865 | ±0.13% | 0.0297ms | 0.0830ms |  |
| 🥉 | **Preact Signals** | 12,069,178.624 | ±0.07% | 0.0829ms | 0.1670ms |  |
| 4 | **MobX** | 2,153,431.915 | ±0.56% | 0.4644ms | 0.8750ms |  |
| 5 | **Jotai** | 394,077.889 | ±4.55% | 2.5376ms | 3.5840ms |  |
...
| Rank | Library | Ops/sec | Variance | Mean | p99 | Samples |
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 19,921,867.928 | ±0.03% | 0.0502ms | 0.0840ms |  |
| 🥈 | **Preact Signals** | 485,568.906 | ±0.12% | 2.0594ms | 3.3330ms |  |
| 🥉 | **Zen** | 454,470.735 | ±0.33% | 2.2004ms | 3.7080ms |  |
| 4 | **MobX** | 39,627.784 | ±0.34% | 25.2348ms | 46.9580ms |  |
| 5 | **Jotai** | 5,174.965 | ±10.46% | 193.2380ms | 492.5830ms |  |
...
---
*Last generated: 2025-11-11T00:33:35.606Z*
