...
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 39,849,314.008 | ±1.32% | 0.0251ms | 0.0830ms |  |
| 🥈 | **Valtio** | 4,819,574.535 | ±0.11% | 0.2075ms | 0.2500ms |  |
| 🥉 | **MobX** | 3,262,647.674 | ±0.21% | 0.3065ms | 0.3750ms |  |
...
| Rank | Library | Ops/sec | Variance | Mean | p99 | Samples |
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 42,490,501.196 | ±0.06% | 0.0235ms | 0.0830ms |  |
| 🥈 | **Valtio** | 4,849,005.874 | ±0.27% | 0.2062ms | 0.2500ms |  |
| 🥉 | **MobX** | 3,799,625.992 | ±0.03% | 0.2632ms | 0.3330ms |  |
...
| Rank | Library | Ops/sec | Variance | Mean | p99 | Samples |
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 27,945,211.82 | ±0.08% | 0.0358ms | 0.0420ms |  |
| 🥈 | **MobX** | 146,456.844 | ±0.03% | 6.8279ms | 8.3750ms |  |
| 🥉 | **Valtio** | 67,668.432 | ±0.28% | 14.7779ms | 17.2920ms |  |
...
| Rank | Library | Ops/sec | Variance | Mean | p99 | Samples |
|------|---------|---------|----------|------|-----|---------|
| 🥇 | **Solid Signals** | 41,108,355.835 | ±0.11% | 0.0243ms | 0.0830ms |  |
| 🥈 | **Valtio** | 4,713,770.906 | ±3.79% | 0.2121ms | 0.2500ms |  |
| 🥉 | **MobX** | 3,205,211.917 | ±0.55% | 0.3120ms | 0.3750ms |  |
...
---
*Last generated: 2025-11-11T00:33:35.684Z*
