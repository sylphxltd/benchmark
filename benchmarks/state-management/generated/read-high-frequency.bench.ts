 ...
 * Scale: High frequency read operations (1000 ops)
 */
...
describe('read - High Frequency', () => {
  ...
  bench('jotai - read (High frequency read operations (1000 ops))', () => {
  ...
  bench('redux-toolkit - read (High frequency read operations (1000 ops))', () => {
  ...
  bench('zustand - read (High frequency read operations (1000 ops))', () => {
