 ...
 * Scale: Single state access operation
 */
...
describe('read - Single Read', () => {
  ...
  bench('jotai - read (Single state access operation)', () => {
  ...
  bench('redux-toolkit - read (Single state access operation)', () => {
  ...
  bench('zustand - read (Single state access operation)', () => {
