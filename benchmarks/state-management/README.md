...
- **⚡ Maximum Performance**: Solid Signals - Fastest overall with 85.1/100 score
- **⚖️ Best Balance**: Zen - Great performance (49.1/100) with good ecosystem
...
| 🥉 3 | **[Zen](https://github.com/SylphxAI/zen)** | 46.4/100 | 54% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 33.6/100 | 39% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Solid Signals](https://github.com/solidjs/solid)** | 85.1/100 | 100% of fastest | [📦](https://www.npmjs.com/package/solid-js) [📊](https://bundlephobia.com/package/solid-js) |
| 🥈 2 | **[Zen](https://github.com/SylphxAI/zen)** | 49.1/100 | 58% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
...
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 36.7/100 | 43% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Solid Signals](https://github.com/solidjs/solid)** | **85.1** | **3.96 KB** | Fine-grained reactivity primitive from Solid.js fo... | Fastest overall, but requires Solid.js e... |
| **[Zen](https://github.com/SylphxAI/zen)** | **49.1** | **1.66 KB** | Minimal and fast state management with signal-base... | Similar performance to Preact, slightly ... |
...
| Preact Signals | 110K | 0.009ms | 0.011ms | 1000 |
...
| Preact Signals | 973 | 1.111ms | 2.147ms | 1000 |
| Zen | 939 | 1.122ms | 2.156ms | 1000 |
...
| Preact Signals | 114K | 0.009ms | 0.018ms | 1000 |
| Zen | 114K | 0.009ms | 0.023ms | 1000 |
...
| Zen | 163K | 0.007ms | 0.011ms | 1000 |
| Preact Signals | 136K | 0.008ms | 0.013ms | 1000 |
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Zen | 153K | 0.007ms | 0.008ms | 1000 |
| Preact Signals | 151K | 0.008ms | 0.017ms | 1000 |
...
| Preact Signals | 717K | 0.001ms | 0.001ms | 1000 |
...
*Generated on 2025-11-14T15:22:01.068Z*
