...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.2/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (96.1/100) with good ecosystem
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 99.1/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 97.5/100 | 98% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 80.2/100 | 81% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.2/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 96.1/100 | 99% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 86.5/100 | 89% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.2** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
| **[SolidJS Router](https://github.com/solidjs/solid-router)** | **96.1** | **9.23 KB** | Universal router for Solid with nested routing and... | General purpose... |
| **[Wouter](https://github.com/molefrog/wouter)** | **86.5** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| Wouter | 5.9M | 0.000ms | 0.001ms | 1000 |
| React Router | 51K | 0.020ms | 0.036ms | 1000 |
| React Router | 19K | 0.055ms | 0.100ms | 1000 |
...
| React Router | 14K | 0.076ms | 0.152ms | 1000 |
...
| Wouter | 3.0M | 0.000ms | 0.001ms | 1000 |
...
| React Router | 22K | 0.046ms | 0.078ms | 1000 |
...
| React Router | 20K | 0.050ms | 0.078ms | 1000 |
...
| React Router | 12K | 0.084ms | 0.113ms | 1000 |
...
| Wouter | 409K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.410ms | 1.008ms | 1000 |
...
| React Router | 14K | 0.072ms | 0.102ms | 1000 |
...
*Generated on 2025-11-16T03:27:26.134Z*
